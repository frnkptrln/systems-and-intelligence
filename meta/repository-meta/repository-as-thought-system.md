...
1. reveal a generative operator,
2. expose a threshold or failure condition,
3. clarify a boundary,
4. provide a measurable artifact,
5. create a bridge between two existing clusters.
