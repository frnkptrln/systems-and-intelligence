...
| Co-stabilization (self-maintenance threshold) | [static-information-and-living-process.md](../../theory/computation/static-information-and-living-process.md) (§open questions) | `[HYPOTHESIZED]` — **not yet measured**; [v1.9](../../lab/benchmarks/inverse-reconstruction/co_stabilization.py) is a boundary/counterexample toy | v1.9 measures super-additive dependency on a fixed substitution-coupled ring, but falsifies the resilience prediction; it rules out that first candidate as sufficient co-stabilization. Redundancy model + population version open. NOT self-binding (phase 6). |
