...
| Concept | Home | Status | Operationalization / anchor |
|:---|:---|:---|:---|
| Inverse-reconstruction benchmark (v0–v1.7) | [lab/benchmarks/inverse-reconstruction/](../../lab/benchmarks/inverse-reconstruction/README.md) | **operationalized** | noise / observability / coverage / interventions / family-search floor / model-exploitation bridge (curse wedge monotone in class size) / weakness-selector bridge (commitment efficiency +2.7 / 0.00 / < −7 by world bias) / marked-guess planners (wmean eliminates the wedge; the exact pessimist overpays) / closed loop (acting is measuring; the argmax is *not* curious — collapse no faster than random; frozen curse persists) / ensemble sweep (52% of the wedge gone by K=4; ensembles cure delusion, not ignorance) |
...
| Co-stabilization (self-maintenance threshold) | [static-information-and-living-process.md](../../theory/computation/static-information-and-living-process.md) (§open questions) | `[HYPOTHESIZED]` — **measured** ([v1.9](../../lab/benchmarks/inverse-reconstruction/co_stabilization.py)) | invisible at rest, reached only by knockout (super-additive cascade above c~0.75; watching < perturbing, fourth appearance); the predicted noise/knockout *trade* falsified — substitution-coupling is fragile both ways (a monoculture); redundancy model + population version open; NOT self-binding (phase 6) — substrate of the consciousness question, not the question |
...
| Consciousness (global availability + self-reconstruction loop) | [consciousness-as-global-availability.md](../../theory/identity/consciousness-as-global-availability.md) | hypothesis (architecture) + `[SPECULATIVE]` (experience — explicitly out of scope) | self-reading universe; Three-Layer agent; GNW/Hofstadter/Metzinger anchors; §Testable Direction now run — [exp5](../../lab/experiments/exp5_availability_dissociation.py) (failure condition not triggered; Δ-K half carried no signal); bounded-not-total integration `[HYPOTHESIZED]` with the collective-attention boundary case in the [loop note](../../theory/core/from-trace-to-world-binding.md); non-convergence (point 4): the self as invariant of the unterminating search; levels = reflexive depth (Kegan 1982, subject-object move = one loop turn; interview-grade anchor), phenomenal degrees out of scope |
| Reflexive depth (Kegan's subject-object move) | [consciousness-as-global-availability.md](../../theory/identity/consciousness-as-global-availability.md) (§On Levels) | `[HYPOTHESIZED]` — **measured** ([exp8](../../lab/experiments/exp8_reflexive_depth.py)) | stages as iterations of one operator, not degrees of experience; depth 2 beats depth 1 under a regime change (+36%; fixed self-model then worse than none) and is powerless against a sole-channel bias (Wall 3); Kegan 1982 interview-grade anchor; depth 3 + external-reference resolution open |
