...
| Concept | Home | Status | Operationalization / anchor |
|:---|:---|:---|:---|
| Inverse-reconstruction benchmark (v0–v1.11) | [lab/benchmarks/inverse-reconstruction/](../../lab/benchmarks/inverse-reconstruction/README.md) | **operationalized** | noise / observability / coverage / interventions / family-search floor / model exploitation / honest uncertainty / closed-loop measurement / ensemble size / composition level-jump (v1.8) / substitution-dependency boundary (v1.9) / budget-matched redundant support (v1.10) / dynamic-population selection boundary (v1.11: acutely useful support selected downward) |
