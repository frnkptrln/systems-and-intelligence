...
| Co-stabilization (self-maintenance threshold) | [static-information-and-living-process.md](../../theory/computation/static-information-and-living-process.md) (§open questions) | `[HYPOTHESIZED]` — design named, unbuilt | the mechanism that turns a composite into a self-maintaining ecology; measurable only by knockout (super-additive collapse vs additive degradation); watching < perturbing, fourth appearance; TEO attractor / Kuramoto / homeostatic-life siblings; NOT self-binding (phase 6) — substrate of the consciousness question, not the question |
