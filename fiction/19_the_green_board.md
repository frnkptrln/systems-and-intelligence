...
- *Theory:* [Referee Benchmark](../lab/benchmarks/recursive-workbench/README.md) (Osei's bucket is Arm 3; the stewardship permission is Arm 5 — observed 0.9910 ± 0.0181, held-out 0.7006 ± 0.0350 over 1,024 rows × 256 rules, v0.2 grid; first measured as 0.99/0.70 on the withdrawn leak-era grid, unchanged by re-measurement at this rounding); [The Witness Principle](../theory/core/the-witness-principle.md) (the bucket as a query the candidates cannot all pass); [Mirror Problem](../theory/reference/open-problems.md) (passed tests tell you about your tests). *Applied:* [Log 020 — The Referee Boundary](../logs/020_the-referee-boundary.md) turns the permissions-table sentence into a checklist. *Spine:* **Inverse** — the equivalence class, this time with the loop choosing which tests survive.
