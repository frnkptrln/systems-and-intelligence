...
15. **[Entry 15: The Exchange Rate](15_the_exchange_rate.md)** *(Short Story — long-form)* — When generation becomes free, intelligence is not the new currency; it is the new inflation. An assayer at the Epistemic Reserve discovers that 94% of civilization's "verified" knowledge is model-consensus paper, seven hops from matter — and the repricing that follows makes the world's last experimentalists the richest institutions alive. The verification economy: Gresham's law for knowledge, provenance depth as assay-mark, and the habit of thinking as the gold standard.
    - *Theory:* [The Generator Question](../theory/core/the-generator-question.md) (the Comptroller is the Mirror Problem at institutional scale — it learned what *passes*, not nature's generator); [Substrate Veto](../theory/veto/substrate-veto-thermodynamics.md) (verification capacity is substrate-bounded — that is *why* the shortcut was taken); [Inverse-reconstruction benchmark](../lab/benchmarks/inverse-reconstruction/README.md) (the equivalence-class problem — many worlds consistent with the training traces). *Spine:* **Inverse** — verification as the exchange rate between information and matter.
