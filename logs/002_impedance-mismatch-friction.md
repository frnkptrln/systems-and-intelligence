...
2. **Action Budgets:** Halt agents before the entropy of their actions exceeds the cognitive bandwidth of the regulator. This is the temporal implementation of the [Biological Veto](../theory/veto/ai-alignment-biological-veto.md).

3. **Structural Bottlenecks:** As argued in [Biological Veto Architecture](../theory/veto/biological-veto-architectural-requirements.md) §4, "many small groups outperform fewer large groups" precisely because communication friction maintains decision-making stability.
...
- [Log 001: The Cosmological Bootloader](001_cosmological-bootloader.md) — the thermodynamic ceiling at cosmic scale
- [The Biological Veto: Architectural Requirements](../theory/veto/biological-veto-architectural-requirements.md) — friction and structural limits as engineering requirements
- [Minimal Thermodynamic Agent Framework](../theory/identity/minimal-thermodynamic-agent.md) — Action Budgets in code
- [The Substrate Veto](../theory/veto/substrate-veto-thermodynamics.md) — why computation is bounded by physics
