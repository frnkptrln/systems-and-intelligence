...
Every act of information processing — and especially the erasure of information — necessarily generates heat (entropy). This is [Landauer's Principle](../theory/veto/substrate-veto-thermodynamics.md), already foundational to the Substrate Veto in this repository.
...
The [Biological Veto](../theory/veto/ai-alignment-biological-veto.md) is not a bug and not an obstacle to progress. It is the **essential error-correction routine of the bootloader.**
...
- [The Substrate Veto: A Thermodynamic Boundary on Intelligence](../theory/veto/substrate-veto-thermodynamics.md) — the local-scale version of the entropy limit
- [Machines of Loving Grace](../theory/narrative/machines-of-loving-grace.md) — the three TEO constraints as the definition of "love"
- [Minimal Thermodynamic Agent Framework](../theory/identity/minimal-thermodynamic-agent.md) — the executable implementation of Action Budgets
- [Limits of Formal Systems](../theory/identity/limits-of-formal-systems.md) — Gödel, Turing, and the boundaries of the formalizable
