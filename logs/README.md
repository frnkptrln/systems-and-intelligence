...
For the full taxonomy, see [`meta/repository-information-architecture.md`](../meta/repository-information-architecture.md).
...
1. [`cosmological-bootloader.md`](cosmological-bootloader.md)
