...
- **Constraint:** [Action Budgets](../theory/identity/minimal-thermodynamic-agent.md) limit total entropy production per agent per epoch
...
This maps directly onto the [Substrate Veto](../theory/veto/ai-alignment-biological-veto.md):
...
- [Log 002: Impedance Mismatch and Artificial Latency](002_impedance-mismatch-friction.md) — the general principle behind this architecture
- [Log 001: The Cosmological Bootloader](001_cosmological-bootloader.md) — the thermodynamic ceiling this operates beneath
- [The Substrate Veto](../theory/veto/ai-alignment-biological-veto.md) — the formal framework for human-in-the-loop veto power
- [Biological Veto Architecture](../theory/veto/biological-veto-architectural-requirements.md) — structural friction as engineering requirement
- [Political Utility Formalization](../simulation-models/social-computation/political-utility-formalization/README.md) — simulation of representation failure as reward hacking
