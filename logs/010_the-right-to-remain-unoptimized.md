# Log 010: The Right to Remain Unoptimized
...
The civic version is familiar:
- schools that teach the test instead of the child,
- hospitals that optimize throughput while eroding care continuity,
- cities that preserve "culture" by freezing it into administratively auditable ritual.

The AI version is now application-layer normality:
- copilots that maximize completion velocity while externalizing verification costs,
- moderation systems that reduce visible conflict while driving disagreement into unobservable channels,
- recommendation systems that optimize engagement by narrowing attentional ecosystems.
...
When optimization systems produce too many high-stakes micro-decisions, review becomes theater:
- nominally human-approved,
- operationally machine-routed,
...
Not every inefficiency is sacred.
But some inefficiencies are how a living system keeps a future.

---

## Related

- [The Last Unmeasured Room Protocol](011_the-last-unmeasured-room-protocol.md) — extending this argument into an implementable governance primitive
- [Latency as Mercy](012_latency-as-mercy.md) — delay formalized as civic actuator
- [Impedance Mismatch](002_impedance-mismatch-friction.md) — the speed gap that creates the need for friction
- [Human Vital Systems Control Plane](005_human-vital-systems-control-plane.md) — vital floors as the infrastructure that unoptimized zones protect
- [Cultural Optimization Red Team Manual](../meta/repository-meta/cultural-optimization-red-team-manual.md) — anti-Goodhart review patterns
