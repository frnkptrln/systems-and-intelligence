...
# Add external simulation paths for analysis
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "..", "simulation-models", "emergent-dynamics", "reaction-diffusion"))
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "..", "simulation-models", "emergent-dynamics", "self-organized-criticality"))
