...
- Validators that CI runs: `validate_links.py`, `validate_nav.py`, `validate_math.py`, `validate_katex.js`, and `audit_repository_freshness.py` (copied counts, benchmark version range, freshness metadata, review candidates).
