...
Why this repository exists, in the sentence I'd give a friend: because I'm curious — because I want to understand, maybe, *was die Welt im Innersten zusammenhält* — what holds the world together at its innermost. What keeps me at it late at night is the same thing, undramatic as it is: some of these questions interest me intrinsically, and they don't let go. I don't have a single best moment to point to yet; the closest current candidate is watching the project's spine make unexpected contact with Joscha Bach's work on machine consciousness — see [the pressure test](theory/identity/machine-consciousness-as-generator-coherence.md). And if I am honest about where the search points: *vielleicht ist die Suche nach dem Generator immer auch ein Stück weit die Suche nach sich selbst* — maybe the search for the generator is always, in part, the search for oneself ([author's coda](theory/core/the-generator-question.md)).
