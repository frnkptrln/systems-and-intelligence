...
- [**Emergence Manifesto v1.1**](theory/emergence-manifesto-v1.1.md) – The hardened theoretical framework: 8 claims with explicit status tags (`[DEMONSTRATED]` / `[HYPOTHESIZED]` / `[OPEN PROBLEM]` / `[SPECULATIVE]`), formal connections, and the Mirror Problem elevated to first-class section.
