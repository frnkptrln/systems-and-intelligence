...
This site is not the repository. The repository holds roughly 250,000 words across 286 Markdown files (the leads lane's intake files are not counted) — about twenty hours of reading. Publishing all of it was the old arrangement, and it made the site unreadable: a first-time reader had no way to tell which five percent carried the argument.
