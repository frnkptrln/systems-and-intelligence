...
- [Simulation Models](simulation-models/utility-engineering/README.md) — executable probes and toy systems.
- [Human Vital Systems Simulation](simulation-models/human-vital-systems/README.md) — current proof artifact for the Vital Floor idea.
- [Architecture Logs](logs/README.md) — applied design notes for governance, deployment, and institutional constraints.
- [Agentic Identity Suite](agentic-test-suite/README.md) — experiments around identity persistence and observer attribution.
...
4. links to related theory and simulations,
