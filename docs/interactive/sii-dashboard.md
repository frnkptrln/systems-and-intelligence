...
<iframe src="sii-dashboard-app.html" width="100%" height="800px" style="border:none; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.5); margin-top: 1rem; background: #06060f;"></iframe>
