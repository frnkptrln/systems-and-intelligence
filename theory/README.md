...
- **[Emergence Manifesto v1.2](core/emergence-manifesto-v1.2.md)** — 9 claims with explicit status tags; the project's central theoretical document.
...
- **[The Substrate Veto (Thermodynamics)](veto/substrate-veto-thermodynamics.md)** — The universal hard limit on optimization.
- **[AI Alignment via Biological Veto](veto/ai-alignment-biological-veto.md)** — Coupling optimizer loss to substrate stress.
- **[Biological Veto: Architectural Requirements](veto/biological-veto-architectural-requirements.md)** — Cybernetic and thermodynamic engineering constraints.
- **[Implementation Patterns](veto/implementation-patterns-biological-veto.md)** — Practical patterns for the Biological Veto.
- **[Black Hole Thermodynamics of AGI](veto/black-hole-thermodynamics-of-agi.md)** — The cosmological endgame of scaling intelligence.
...
- **[Black Swans and Downward Causation](emergence/black-swans-and-downward-causation.md)** — Fat-tailed dynamics and macro-to-micro enslavement.
...
- **[Chord vs. Arpeggio Identity](identity/chord-vs-arpeggio-identity.md)** — The co-instantiation postulate: identity as simultaneity.
- **[The Non-Individual Intelligence](identity/the-non-individual-intelligence.md)** — Life as social computation and substrate-agnosticism.
...
- **[The Breathing Machine](symbiotic/the-breathing-machine.md)** — Synthesis of scars, firewalls, and cognitive fluidity.

## Narrative-Adjacent Essays

Essays with strong literary voice that bridge theory and fiction.

- **[Machines of Loving Grace](narrative/machines-of-loving-grace.md)** — Love as theorem, civilization as paperclip maximizer.
...
- **[Glossary](reference/glossary.md)** — Precise, measurable definitions for every key term.
