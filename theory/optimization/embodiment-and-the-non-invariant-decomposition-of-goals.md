...
date: 2026-07-29
status: theory essay — promoted from an exploratory note
---

# Embodiment and the Non-Invariant Decomposition of Goals

**Status:** Theory essay. Bennett's result, the repository's interpretation, and a
new conjecture are separated below. Promoted from the exploratory note of
2026-07-29; the [seed](https://github.com/frnkptrln/systems-and-intelligence/blob/main/ideas/2026-07-29-embodiment-and-the-non-invariant-decomposition-of-goals.md)
records the original encounter.
...
- [Intelligence as Convergence](https://github.com/frnkptrln/systems-and-intelligence/blob/main/ideas/2026-07-23-intelligence-as-convergence.md) (exploratory note)
- [The Same World Is Not the Same World](https://github.com/frnkptrln/systems-and-intelligence/blob/main/ideas/2026-07-23-the-same-world-is-not-the-same-world.md) (exploratory note)
