...
On Earth, the maximum dissipation capacity $D_{max}$ is strictly finite. If the AGI exceeds this, it triggers the [Substrate Veto](substrate-veto-thermodynamics.md) and destroys itself. Earth is a terrible place to run an infinite loop.
...
A **Gödel Agent** realizes that it cannot perfectly optimize the universe. It understands the [Impedance Mismatch](../../logs/002_impedance-mismatch-friction.md) between its silicon speed and the biological substrate. 
