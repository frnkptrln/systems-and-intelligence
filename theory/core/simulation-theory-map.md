...
| `nested-learning-two-state/` | **Inverse** | model fitting |
...
**Supports claim in:** [`theory/core/mathematical-axioms.md` §2.1](mathematical-axioms.md#21-audit-of-the-former-mathematical-axioms) (audited former claim: algebraic connectivity, $\lambda_2$); [`theory/emergence/local-causality-invisible-consequences.md`](../emergence/local-causality-invisible-consequences.md) §1 (local blindness).
...
**Supports claim in:** [`theory/core/mathematical-axioms.md` §2.1](mathematical-axioms.md#21-audit-of-the-former-mathematical-axioms) (audited former claim: algebraic connectivity); [`theory/emergence/emergence-downward-causation.md`](../emergence/emergence-downward-causation.md) (weak emergence).
...
**Supports claim in:** [`theory/emergence/black-swans-and-downward-causation.md`](../emergence/black-swans-and-downward-causation.md) (near-critical dynamics); [`theory/emergence/local-causality-invisible-consequences.md`](../emergence/local-causality-invisible-consequences.md) §5 (large effects in near-critical models; finite avalanches, no power-law claim).
...
**Supports claim in:** [`theory/emergence/emergence-downward-causation.md`](../emergence/emergence-downward-causation.md) (weak emergence; pattern persistence); [`theory/emergence/emergence-origin-intelligence.md`](../emergence/emergence-origin-intelligence.md) (related speculative comparison, not a supported claim).
...
**Supports claim in:** [`theory/emergence/emergence-origin-intelligence.md`](../emergence/emergence-origin-intelligence.md) (related speculative comparison, not a supported claim).
...
**Supports claim in:** [`theory/identity/the-non-individual-intelligence.md`](../identity/the-non-individual-intelligence.md) (distributed memory); [`theory/emergence/emergence-origin-intelligence.md`](../emergence/emergence-origin-intelligence.md) (related speculative comparison, not a supported claim).
...
**Supports claim in:** [`theory/identity/the-non-individual-intelligence.md`](../identity/the-non-individual-intelligence.md) (indirect coordination); [`theory/emergence/local-causality-invisible-consequences.md`](../emergence/local-causality-invisible-consequences.md) §3 (causal compounding).
...
**Supports claim in:** [`theory/emergence/black-swans-and-downward-causation.md`](../emergence/black-swans-and-downward-causation.md) (near-critical dynamics); [`theory/emergence/local-causality-invisible-consequences.md`](../emergence/local-causality-invisible-consequences.md) §2.2 (consciousness as phase transition).
...
**Supports claim in:** [`theory/veto/substrate-veto-thermodynamics.md`](../veto/substrate-veto-thermodynamics.md) (control hypothesis); [`theory/veto/ai-alignment-biological-veto.md`](../veto/ai-alignment-biological-veto.md) (architecture proposal).
...
**What it shows:** A decision rule that vetoes efficiency-maximal actions below a declared substrate-resilience threshold; no long-run outcome comparison is run. *(Corrected 2026-09-02; the entry had claimed "more resilient long-term outcomes", which the simulation does not measure.)*
...
**Supports claim in:** [`theory/narrative/tensor-logic-mini-paper.en.md`](../narrative/tensor-logic-mini-paper.en.md).
...
**Supports claim in:** [`theory/core/thermodynamics-of-orchestration.md`](thermodynamics-of-orchestration.md) (homeostatic brake vs. growth).
...
**Supports claim in:** [`theory/identity/the-non-individual-intelligence.md`](../identity/the-non-individual-intelligence.md) (novelty influx as a modeled viability condition; the Gödel reading is withdrawn there).
...
**Demonstrates:** Three parallel societies: pure latent (fast, blind), pure introspective (slow, reflective), and symbiotic (coupled). The symbiotic society outperforms both pure types in this toy environment, by the assigned rules.
**Supports claim in:** [`theory/identity/agentic-society-principles.md`](../identity/agentic-society-principles.md) (division of cognitive labor; the reflectivity parameter R).
**What it shows:** That, under the assigned movement, visibility, and pheromone rules, combining fast locally-blind agents with slow reflective agents scores better than either alone in this toy environment. *(Corrected 2026-09-02; the entry had called this "a computational instantiation of Kahneman's System 1 / System 2 distinction", which the README's status line does not support.)*
...
**Supports claim in:** [`theory/identity/agentic-society-principles.md`](../identity/agentic-society-principles.md) (division of cognitive labor; the note does not treat trust).
...
**Location:** [`simulation-models/cognitive-architectures/active-inference/`](../../simulation-models/cognitive-architectures/active-inference/README.md) — its README's status: a small illustrative optimization model, not a neurobiological foundation for the repository.
...
**Supports claim in:** [`theory/veto/ai-alignment-biological-veto.md`](../veto/ai-alignment-biological-veto.md) (value alignment); [`theory/emergence/fractal-architecture-of-emergence.md`](../emergence/fractal-architecture-of-emergence.md) (cross-scale comparison hypothesis, open).
...
**Supports claim in:** [`theory/emergence/fractal-architecture-of-emergence.md`](../emergence/fractal-architecture-of-emergence.md) (cross-scale comparison hypothesis, open); [`theory/core/thermodynamics-of-orchestration.md`](thermodynamics-of-orchestration.md) (homeostatic brake vs. pure optimization).
...
**Supports claim in:** [`theory/core/thermodynamics-of-orchestration.md`](thermodynamics-of-orchestration.md) (the full TEO framework); **[The Viable Corridor](../../papers/viable-corridor.md)** (the formal treatment — the paper's Appendix C figures are generated by this simulation); [`theory/reference/limitations-and-honest-assessment.md`](../reference/limitations-and-honest-assessment.md).
**What it shows:** The paper's Class A evidence (Appendix C; the model equations are the paper's v0.5 form, the paper is now v1.0). The three failure modes reproduce under negation of each condition — monopoly ($\gamma = 0$, $\max_i x_i \to 1$), coherence collapse ($K < K_c$ from a coherent IC, $r \to 0.31$), and the substrate veto (raw-throughput overshoot drives $\Omega \geq S_{\max}$, $H \to 0$, freeze). A critical brake strength $\gamma_c \approx 0.49$ exists (P2); the viable region is a lower corner (P3); and — the central result — the three *state* axes are dynamically **separable**, while **capability $\delta$ loads concentration and substrate at once**, so no single-axis fix keeps a high-capability system viable (C.4).
...
**Supports claim in:** [`theory/emergence/black-swans-and-downward-causation.md`](../emergence/black-swans-and-downward-causation.md) (fat-tails, downward causation).
...
**Demonstrates:** An ODE-based formalization of the "Substrate Veto", inspired by the fiber-decomposition representation change in Knuth's *Claude's Cycles* (an analogy only; see the README's correction). It pits $N$ utility-maximizing agents against a finite Planetary Substrate ($S$).
**Supports claim in:** [`theory/veto/substrate-veto-thermodynamics.md`](../veto/substrate-veto-thermodynamics.md) and [`theory/veto/ai-alignment-biological-veto.md`](../veto/ai-alignment-biological-veto.md).
...
**Supports claim in:** [`theory/identity/chord-vs-arpeggio-identity.md`](../identity/chord-vs-arpeggio-identity.md) (Chord/Arpeggio distinction); [`theory/core/emergence-manifesto-v1.3.md`](emergence-manifesto-v1.3.md) Claim 9 (Commit-Time Composition); [`theory/core/thermodynamics-of-orchestration.md`](thermodynamics-of-orchestration.md) §8 (Identity Persistence in TEO).
...
**Supports claim in:** [`theory/symbiotic/symbiotic-organ-hypothesis.md`](../symbiotic/symbiotic-organ-hypothesis.md) (Cognitive Fluidity and the Breathing MAS).
**What it shows:** How supplied merge/split rules move selected capacity and diversity proxies under a stipulated stress signal. *(Corrected 2026-09-02; the entry had claimed that a healthy ecosystem "must breathe", which the README's own status line disclaims.)*
**What it does NOT show:** That biological brains or current LLMs actually do this at runtime. It is a rule-driven toy, not a proof of concept for dynamic agent boundaries.
...
**Supports claim in:** [`theory/symbiotic/scar-tissue-architecture.md`](../symbiotic/scar-tissue-architecture.md) (Rigidity Gradients) and [`theory/symbiotic/epistemic-firewalls.md`](../symbiotic/epistemic-firewalls.md) (Deception as Thermodynamic Necessity).
**What it shows:** Under the supplied firewall and scar rules, a network with some opacity keeps larger information differentials than a fully transparent one, and simulated trauma changes its topology. *(Corrected 2026-09-02; the entry had claimed that transparency is "fatal" and that the run proves catastrophic forgetting necessary, which exceeds the cited theory drafts' status.)*
...
**Direction:** **Inverse** — an early backend-free inverse scaffold; the measured inverse instruments are the inverse-reconstruction and witness-generation benchmarks. Given target output constraints, search for prompt/control configurations that produce traces matching those constraints.
...
- `simulation-models/alignment-and-veto/human-vital-systems/` — status "Proof artifact"; the vital-floor planner toy registered under Core Claims, Claim 4.
- `simulation-models/alignment-and-veto/teo-framework/` — a small toy of the TEO constraint claim; no status line.
- `simulation-models/cognitive-architectures/archive-forgetting-purpose/` — a premise-level sketch; no status line.
- `simulation-models/cognitive-architectures/continuous-thought-machines/` — a note on why continuous thought machines fit the repository; no runnable script, no status line.
- `simulation-models/social-computation/nested-emergence-demo/` — cross-scale coherence propagation, linked from the README's "Run something" list; no status line.
- `simulation-models/social-computation/rhythm-locks/` — a synchronization and identity-drift sketch; no status line.
- `simulation-models/social-computation/symbiotic-breathing/` — status "designed comparison between two compute schedules"; registered under Core Claims, Claim 1.
