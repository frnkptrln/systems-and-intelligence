...
**Repository anchors:** [The Generator Question](../core/the-generator-question.md), [From Trace to World-Binding](../core/from-trace-to-world-binding.md), [The Transition Problem](../veto/the-transition-problem.md), [The Non-Individual Intelligence](../identity/the-non-individual-intelligence.md), and [The Viable Corridor](../../papers/viable-corridor.md).
...
1. participants contribute capacities, constraints, or standpoints that are not fully substitutable;
2. they work through a shared object or environment that can resist their expectations;
3. information from one participant can materially revise the next move of another;
4. authority, veto, and responsibility remain explicit rather than dissolving into the group; and
5. the resulting construction reaches a verified form that was outside the practical repertoire of any participant acting alone under comparable limits.
...
1. **Complementarity test:** Does a structured heterogeneous system produce independently verified solutions that the strongest isolated participant does not reach under comparable time and resource limits?
2. **Revision test:** Do cross-participant challenges materially change the chosen construction, or do humans and institutions merely approve a plan already fixed elsewhere?
3. **Authority test:** Can affected participants veto or redirect consequential action without first translating every concern into the optimizer's preferred metric?
4. **Viability test:** Do gains remain after review labor, verification cost, substrate use, and harm displaced onto less powerful participants are counted?
...
- [Repository as Thought System](../../meta/repository-meta/repository-as-thought-system.md) — the repository as workspace, not subject
- [The Right to Remain Unoptimized](../../logs/010_the-right-to-remain-unoptimized.md) — opacity, latency, and refusal as viability infrastructure
- [Latency as Mercy](../../logs/012_latency-as-mercy.md) — protective delay in tightly coupled systems
- [Cultural Optimization Red Team Manual](../../meta/repository-meta/cultural-optimization-red-team-manual.md) — anti-Goodhart checks for cultural systems
