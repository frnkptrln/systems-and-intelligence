...
The script in simulation-models/cognitive-architectures/tensor-logic-reasoning/tensor_logic_demo.py constructs a minimal world containing four entities:
