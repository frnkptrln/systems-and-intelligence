...
- [**The AI Alignment Veto: A Thermodynamic Hypothesis (Toy Formalization)**](ai-alignment-biological-veto.md) — What happens when the global consequence of a locally blind optimization process is the destruction of its substrate — and one toy coupling mechanism using a Free-Energy-like stress proxy.
