...
**Status:** Open collection of exploratory notes — not repository claims.

This directory holds small, self-contained exploratory notes. Each note captures one observation, question, hypothesis, analogy, or disturbance before it needs a stable place in a theory, chapter, experiment, or concept registry.

Notes are intentionally small — usually around 100–200 words. They preserve enough context to recover why an idea mattered, name what remains open, and link to genuine neighbours when those exist. They are not miniature essays and do not need a category, mechanism, falsifier, or destination merely to be recorded.

## Working rhythm

`note → connections → cluster → essay / experiment / chapter → synthesis`

The arrows are possibilities, not obligations. Most work happens by accumulation: when several notes keep pointing to one another, a cluster may have appeared. Only then is it worth asking whether a larger artifact is needed.

## Minimal shape

Each note should contain:

- one observation, question, or hypothesis;
- a little context;
...
- [When Does a Collection Become an Agent?](2026-09-03-when-does-a-collection-become-an-agent.md) — asks when predictive and control structure becomes usefully collective under a declared coarse-graining rather than merely coordinated
- [Closure Can Open a New Possibility Space](2026-09-03-closure-can-open-a-new-possibility-space.md) — asks whether organizational closure can create a new effective unit with new reachable or controllable possibilities rather than only reducing degrees of freedom
- [Macro Agency Needs Downward Control](2026-09-03-macro-agency-needs-downward-control.md) — distinguishes a useful macro-description from a macro-level control organization by requiring a realizable intervention advantage
- [Collective Self-Knowledge May Require Synergy](2026-09-03-collective-self-knowledge-may-require-synergy.md) — treats joint-only self-predictive information as an architectural diagnostic without promoting it to a consciousness criterion
...
- [Persistence Can Narrow the Search Space](2026-08-11-persistence-can-narrow-search-space.md) — asks whether accumulated research memory improves local usefulness while pulling exploration toward existing conceptual attractors; developed in: [Persistence and Search Narrowing](../lab/experiments/persistence_narrowing/README.md)
...
- [The Teacher Is Part of the Environment](2026-08-10-teacher-is-part-of-environment.md) — distinguishes supervision as measurement from supervision as coupling
- [Representation Changes Reconstruction Difficulty](2026-08-09-representation-changes-reconstruction-difficulty.md) — representational grounding as a possible separation between identifiability and search accessibility; developed in: [Representation and Reconstruction Difficulty](../lab/experiments/representation_reconstruction/README.md)
