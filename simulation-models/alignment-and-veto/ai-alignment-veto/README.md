...
Instead of abstract morality, this simulation introduces a strictly systemic, thermodynamic mechanism: **The Substrate Veto** (and specifically for Earth, **The Biological Veto**). See [Theory: Substrate Veto](../../../theory/veto/substrate-veto-thermodynamics.md) for full context.
